    ...
    <footer className="border-t border-zinc-800 bg-zinc-950">
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          {/* suppressHydrationWarning prevents React from flagging the year mismatch
              between server-rendered HTML and client hydration (timezone differences) */}
          <p className="text-sm text-zinc-500" suppressHydrationWarning>
            © {new Date().getFullYear()} Ken Zamariyan. All rights reserved.
          </p>
