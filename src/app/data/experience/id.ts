import type { Experience } from "./en";

export const experiencesId: Experience[] = [
  {
    year: "2026",
    title: "Pengembang Full-Stack (Proyek Hackathon)",
    place: "ContractChill — #JuaraVibeCoding",
    location: "Remote",
    description:
      "Membangun penganalisis dokumen hukum bertenaga AI menggunakan Google Gemini AI, backend Node.js/Express, frontend React, Firebase Auth, dan deployment Docker di Google Cloud Run. Menganalisis kontrak PDF dalam waktu kurang dari 15 detik dengan 4 persona AI.",
    tags: ["React", "TypeScript", "Node.js", "Express", "Gemini AI", "Firebase", "Docker", "GCP"],
    type: "work",
  },
  {
    year: "Jan 2024 - Present",
    title: "Pengembang Web & Mobile Lepas",
    place: "Mandiri",
    location: "Remote",
    description:
      "Mengembangkan aplikasi web dan mobile end-to-end di berbagai domain — fintech, e-commerce, legal-tech, produktivitas, dan agritech. Dari requirements dan arsitektur hingga implementasi dan deployment.",
